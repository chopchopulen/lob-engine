...
(clean synthetic repro produces sane spreads).
...
- ~~AMZN's contemporaneous OFI→return R² unexplained~~ — **resolved 2026-07-24**: root cause
  ...
  research data is stale" finding above, and by the "Lesson learned" section — AAPL's
  plausible-looking R² was never valid evidence the pipeline was correct in the first place.
